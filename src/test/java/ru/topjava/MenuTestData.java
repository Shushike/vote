...
public class MenuTestData {
    ...
    public static final List<Menu> menus = List.of(menu5, menu6, menu2, menu4, menu1, menu3);
    public static final List<Menu> restaurant1_menus = List.of(menu6, menu2, menu1);
